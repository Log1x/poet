...
If WP_DEBUG is false - as it should be in production and staging - the registration/unregistration of user roles is automatically triggered via [Trellis](https://roots.io/trellis/) after a successful deploy.
